...
public class SupplierRegisterPageController : Controller
{
        ...
        [FromQuery] string? comune)
    {
        ...
        var audience = _config["Auth0:Audience"] ?? "https://casazen-api";
...
<div class=""card"" id=""success-card"" style=""display:none;text-align:center"">
  ...
  <p class=""desc"">Il tuo profilo fornitore &egrave; stato creato. Ora crea il tuo account per accedere alla console.</p>
