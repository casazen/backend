    ...
    ILogger<PropertiesController> logger) : ControllerBase
{
    ...
    /// checklist is saved with <see cref="SaveSafetyChecklist"/> (CO-07). Also the reactivation of a suspended property
    /// (CO-06): with blockers left an active property is suspended and a pending or suspended one keeps its status
