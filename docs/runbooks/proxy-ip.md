...
| `PublicBookingLookup` | `POST api/public/bookings/lookup`, `POST api/public/bookings/{id}/confirm-email` ("pay at the property" link, BK-06) | 30 / min | `RateLimiting__PublicBookingLookup__PermitLimit` |
