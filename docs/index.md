...
| [AI-STRATEGY.md](./AI-STRATEGY.md) | AI reality check (current pricing is rule-based, not AI), AI roadmap for the PMS core (predictive pricing, compliance assistant, guest comms), and the net-new AI-powered supplier & services marketplace — matching, acquisition CRM, reputation ranking. | ai-strategy, vision, marketplace, suppliers, llm, roadmap, positioning |
