...
| [TECHNICAL.md](./TECHNICAL.md) | Layered .NET 10 architecture (Web → Core → Infrastructure), full API endpoint catalog, EF Core data model, design patterns (Repository, Adapter, Mediator), Auth0 + Stripe + MailKit SMTP + OTA integrations, Polly resilience. | architecture, api, dotnet, ef-core, auth0, stripe, ota, docker |
