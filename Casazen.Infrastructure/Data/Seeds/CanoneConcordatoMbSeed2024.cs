...
/// <summary>
/// FROZEN (LT-10): the Monza e Brianza data exactly as the migration <c>20260816203709_AddTerritorialRentAgreements</c>
/// inserted them. Used only by that migration, so later changes to the reference data never change its behaviour (A7-22):
/// never edit this class. The current data are <see cref="CanoneConcordatoMbSeed"/>, applied by later migrations.
/// </summary>
/// <remarks>
...
/// 54 comuni: Misinto was missing (RS-8 found 55 in the agreement); LT-10 adds it with a later migration.
/// </remarks>
public static class CanoneConcordatoMbSeed2024
{
