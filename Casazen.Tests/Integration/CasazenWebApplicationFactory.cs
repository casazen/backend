    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, config) =>
        {
            config.AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["Compliance:CinGuidanceUrl"] = "https://www.bdsr.it/",
                ["Compliance:CheckoutReminderHourLocal"] = "20",
                ["Compliance:RequiredDocuments:DEFAULT:0"] = "CinCertificate",
                ["Compliance:RequiredDocuments:LOM:0"] = "CinCertificate",
                ["Compliance:RequiredDocuments:LOM:1"] = "Scia",
                ["Compliance:RequiredDocuments:LOM:2"] = "SafetyCertificate",
